 ...
 * "Acme Corp," etc.). Kept deliberately separate from Friends: a friend
...
// ensureRecurringExpensesSheet_. Seeds "Acme Corp" at creation time so
...
function ensurePayorsSheet_() {
  ...
  sheet.appendRow([Utilities.getUuid(), 'Acme Corp', '']);
}
